...
public class PeopleJob implements WritableComparable<PeopleJob> {

    public Text job = new Text();
    public IntWritable recordType = new IntWritable();
    public PeopleJob(){}

    public PeopleJob(String job, IntWritable recordType) {
        this.job.set(job);
        this.recordType = recordType;
    }
    @Override
    public int compareTo(PeopleJob other) {
    ...
    public boolean equals (PeopleJob other) {
